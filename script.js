...
const cards = document.querySelectorAll('.card, .info-card, .timeline-card, .skill-card, .contact-card, .family-card');
cards.forEach(card => {
...
if (footerText) {
    footerText.textContent = `© ${currentYear} Rimarch Dizon. All rights reserved.`;
}
